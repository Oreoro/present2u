...
ActiveRecord::Schema[8.2].define(version: 2026_09_19_160836) do
  ...
  create_table "leaves", force: :cascade do |t|
    ...
    t.boolean "sketch", default: false, null: false
    t.string "status", null: false
    t.string "title", null: false
    t.datetime "updated_at", null: false
    t.index ["book_id", "p2u_id"], name: "index_leaves_on_book_id_and_p2u_id"
  ...
  create_table "typsts", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.text "source"
    t.datetime "updated_at", null: false
  end
